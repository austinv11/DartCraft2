 ...
 * This means that the player must make difficult choices about how their aura system works.
 * 
 ...
 * Phew, that was a lot.
 */
@API(owner = "DartCraft2", provides = "DartCraft2|API", apiVersion = Reference.VERSION)
